...
├── Crypto_Market_Dashboard_Final.ipynb   # Main notebook
...
```bash
git clone https://github.com/vrut-data/crypto-market-dashboard.git
...
### 4. Add your API key
Open `Crypto_Market_Dashboard_Final.ipynb` and paste your key into the designated cell near the top:
```python
...
[www.linkedin.com/in/vrutantvaghela](#) · [GitHub](https://github.com/vrut-data)
